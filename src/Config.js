...
const Config = {
  primaryColor: '#ffffff',
  primaryColorLight: '#e1e1e1',
  secondaryColor: '#a6c314',
  textColor: '#4E4E4E',
  buttonColor: '#000000',
  ...
  api: {
    id: 2,
    grantType: 'password',
    secret: 'WVsZqKNVLO2YA2UHX4W21XrSMqrq2n8S2XVNc8lo',
    authUrl: domain + 'api/AspNetUser/authenticate',
    path: domain + 'api/v1/',
  },
  socket: {
    authUrl: domain + 'api/v1/auth-socket',
    host: 'adviser.geekadvice.pe',
    port: 3030,
    appKey: '9201ff5d94ac55b1',
    appID: 563604,
    cluster: 'us2',
  },
  google: {
    apiKey: 'AIzaSyC3U58pxs3K_8WcShoW5U2QcTPSMJE-x38',
    directionsColor: '#475975',
  },
};
