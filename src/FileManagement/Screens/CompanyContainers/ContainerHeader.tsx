        ...
        <ButtonGroup>
          <Tooltip
            ...
            <Button
              ...
              icon={
                <span className="button-icon-alone icon-notification-circle"></span>
              }
            />
          </Tooltip>
        </ButtonGroup>
        <ButtonGroup>
          <Tooltip title={'Subir un nivel'}>
            <Button
              onClick={upLevel}
              icon={
                <span className="button-icon-alone icon-folder-upload"></span>
              }
            />
          </Tooltip>
          <Tooltip title={'Nuevo folder'}>
            <Popover
              ...
              <Button
                icon={
                  <span className="button-icon-alone icon-folder-plus"></span>
                }
              />
            </Popover>
          </Tooltip>
