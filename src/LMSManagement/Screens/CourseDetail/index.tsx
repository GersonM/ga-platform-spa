...
import {Checkbox, Col, _Collapse, Form, Input, InputNumber, _List, Modal, Row, Space} from 'antd';
import {PlusIcon, _TrashIcon} from '@heroicons/react/24/solid';
...
import _CourseForm from '../../Components/CourseForm';
