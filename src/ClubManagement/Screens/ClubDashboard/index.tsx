  ...
  return (
    <ModuleContent>
      ...
      <div style={{
        ...
        <Card title="Día más activo" size="small">
          <div style={{textAlign: 'center'}}>
        ...
        <div style={{overflowX: 'auto'}}>
          <table style={{width: '100%', borderCollapse: 'collapse'}}>
            ...
            <tr style={{borderBottom: '2px solid #f0f0f0'}}>
              ...
              <th style={{padding: '12px', textAlign: 'center'}}>Indice de asistencia</th>
            </tr>
            </thead>
            <tbody>
            {top_users.map((user, index) => {
              //const maxAttendances = top_users[0]?.total_attendances || 1;
              const percentage = calculatePercentage(user.total_attendances, 30);
